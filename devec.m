function [bestmem,bestval,nfeval] = devec(fname,VTR,D,XVmin,XVmax,y,NP,itermax,F,CR,strategy,refresh);
...
err=[];
if nargin<1, error('devec 1st argument must be function name'); else 
...
Z1 = X1.*sin(4*X1)+1.1*Y1.*sin(2*Y1);
